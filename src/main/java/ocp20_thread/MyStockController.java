...
public class MyStockController implements Runnable {
    ...
    public MyStockController(String symbol, JLabel priceLable, JLabel changeJLabel) {
        this.symbol = symbol;
        this.priceLabel = priceLable;
        this.changeJLabel = changeJLabel;
        play = true;
    }
